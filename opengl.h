...
extern Texture_Map *last_applied_diffuse_map;
...
my_pair<Texture_Map*, Texture_Map*> create_texture_render_target(i32 width, i32 height, bool do_depth_target = false, bool do_hdr = false, bool do_multisampling = false);
